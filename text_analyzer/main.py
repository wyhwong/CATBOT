...
def main() -> None:
    ...
    if tweepy_consumer_key and tweepy_consumer_secret and tweepy_access_token and tweepy_access_token_secret:
        twitter_scraper = TwitterScraper(
            tweepy_consumer_key, tweepy_consumer_secret, tweepy_access_token, tweepy_access_token_secret
        )
    else:
    ...
    handler = Handler(text_scraper, reddit_scraper, twitter_scraper, text_inference, publisher)
