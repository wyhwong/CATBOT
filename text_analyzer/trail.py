...
for epoch in range(epochs):
    ...
    print('Epoch:', epoch+1, 'Val accuracy:', accuracy_score(val_labels, val_preds), 'Val precision:', precision_score(val_labels, val_preds, average='weighted'), 'Val recall:', recall_score(val_labels, val_preds, average='weighted'), 'Val F1 score:', f1_score(val_labels, val_preds, average='weighted'), 'Val confusion matrix:', confusion_matrix(val_labels, val_preds))
